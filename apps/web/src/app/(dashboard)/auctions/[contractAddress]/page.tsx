          ...
          <div className="mt-4 flex flex-shrink-0 gap-2 md:ml-4 md:mt-0">
            ...
            {auctionHasEnded ? (
              <Button
                ...
                startContent={<FaBitcoin className="h-4 w-4" />}
      ...
      <AuctionDetailsSection
        items={[
          ...
          },
          {
            name: "End Time",
            element: new Date(
              auctionStartDate.getTime() + Number(auctionDuration) * 1000,
            ).toLocaleString(),
          },
          {
            name: "Duration",
...
function StatCard({
  ...
  return (
    <Card>
      <CardBody
        className={clsx(
          highlighted ? "bg-gray-800" : "bg-gray-800",
          "text-white",
        )}
      >
